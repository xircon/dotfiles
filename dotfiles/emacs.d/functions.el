...
(defun load-cfg()
  ...
  ;; Load Settings files:
  ;; ********************
  (let ((myfiles '("theme-changes.el" "load-pkg.el" "functions.el" "easy-menus.el" "shortcuts.el" "mybookmarks.el"
                   "hyper-sc.el" "ctrl-sc.el" "hydra-conf.el" "keychords-sc.el" "cursor-chg.el")))
    (while myfiles
      (load (concat "/home/steve/.emacs.d/My-emacs/" (car myfiles)) (pop myfiles))))
  (kill-shell-buffers)
  )
;; ********************************************************************
...
(defun google-cal ()
  (interactive)
  (require 'calfw-ical)
  (cfw:open-ical-calendar "https://calendar.google.com/calendar/ical/xirconuk%40gmail.com/public/basic.ics"))
...
(defun my-open-calendar ()
  ...
  (cfw:open-calendar-buffer
   ...
   (list
    ...
    (cfw:ical-create-source "gcal1" "https://calendar.google.com/calendar/ical/xirconuk%40gmail.com/public/basic.ics" "Blue") ; google calendar ICS
    (cfw:ical-create-source "gcal2" "https://calendar.google.com/calendar/ical/j3uevg4ng7eq7mvn6gcj8e17os%40group.calendar.google.com/public/basic.ics" "IndianRed") ; google calendar ICS
    )))
